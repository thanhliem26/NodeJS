...
exports.postInfoDoctor = exports.postBulkCreateSchedule = exports.getTopDocTor = exports.getScheduleByDate = exports.getDetailDoctorById = exports.getAllDortors = void 0;
var DoctorService = _interopRequireWildcard(require("../services/doctorService"));
...
exports.getTopDocTor = getTopDocTor;
var getAllDortors = /*#__PURE__*/function () {
  ...
  return function getAllDortors(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.getAllDortors = getAllDortors;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return DoctorService.saveDetailInfoDoctor(req.body);
          case 3:
...
exports.postInfoDoctor = postInfoDoctor;
...
var postBulkCreateSchedule = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            return _context5.abrupt("return", res.status(200).json(schedule));
          case 7:
            _context5.prev = 7;
  ...
  return function postBulkCreateSchedule(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
exports.postBulkCreateSchedule = postBulkCreateSchedule;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return DoctorService.getScheduleByDate(req.query.doctorId, req.query.date);
          case 3:
            schedules = _context6.sent;
            return _context6.abrupt("return", res.status(200).json(schedules));
          case 7:
            _context6.prev = 7;
